...
driver.get("https://www.thepwhl.com/en/stats/player-stats/all-teams/1?sort=gaa&playertype=goalie&qualified=all&rookie=no&statstype=standard&page=1&league=1")
...
with open(r"C:\Users\cashm\Downloads\pwhl-fantasy\GoalieOutput.csv", 'w+', encoding='utf16') as c:
  sentinel = True
  while sentinel:
